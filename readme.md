...
So this use case is not suitable for your application workload. But by walking throught this example, certainly you will get a good and new perspective about cache system like Amazon Elasticache when you are implementing scalable web scale services.* 
